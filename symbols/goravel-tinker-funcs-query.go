// Code generated by 'yaegi extract goravel-tinker/funcs/query'. DO NOT EDIT.
...
import (
	"goravel-tinker/funcs/query"
	"reflect"
)

func init() {
	Symbols["goravel-tinker/funcs/query/query"] = map[string]reflect.Value{
