...
func (W _gorm_io_gorm_ColumnType) ColumnType() (columnType string, ok bool) {
	return W.WColumnType()
}
func (W _gorm_io_gorm_ColumnType) Comment() (value string, ok bool) {
	return W.WComment()
}
func (W _gorm_io_gorm_ColumnType) DatabaseTypeName() string {
	return W.WDatabaseTypeName()
}
func (W _gorm_io_gorm_ColumnType) DecimalSize() (precision int64, scale int64, ok bool) {
	return W.WDecimalSize()
}
func (W _gorm_io_gorm_ColumnType) DefaultValue() (value string, ok bool) {
	return W.WDefaultValue()
}
func (W _gorm_io_gorm_ColumnType) Length() (length int64, ok bool) {
	return W.WLength()
}
func (W _gorm_io_gorm_ColumnType) Name() string {
	return W.WName()
}
func (W _gorm_io_gorm_ColumnType) Nullable() (nullable bool, ok bool) {
	return W.WNullable()
}
func (W _gorm_io_gorm_ColumnType) PrimaryKey() (isPrimaryKey bool, ok bool) {
	return W.WPrimaryKey()
}
func (W _gorm_io_gorm_ColumnType) ScanType() reflect.Type {
	return W.WScanType()
}
func (W _gorm_io_gorm_ColumnType) Unique() (unique bool, ok bool) {
	return W.WUnique()
}
...
func (W _gorm_io_gorm_Dialector) DataTypeOf(a0 *schema.Field) string {
	return W.WDataTypeOf(a0)
}
...
func (W _gorm_io_gorm_Dialector) Initialize(a0 *gorm.DB) error {
	return W.WInitialize(a0)
}
func (W _gorm_io_gorm_Dialector) Migrator(db *gorm.DB) gorm.Migrator {
	return W.WMigrator(db)
}
func (W _gorm_io_gorm_Dialector) Name() string {
	return W.WName()
}
func (W _gorm_io_gorm_Dialector) QuoteTo(a0 clause.Writer, a1 string) {
	W.WQuoteTo(a0, a1)
}
...
func (W _gorm_io_gorm_ErrorTranslator) Translate(err error) error {
	return W.WTranslate(err)
}
...
func (W _gorm_io_gorm_GetDBConnector) GetDBConn() (*sql.DB, error) {
	return W.WGetDBConn()
}
...
func (W _gorm_io_gorm_Index) Columns() []string {
	return W.WColumns()
}
func (W _gorm_io_gorm_Index) Name() string {
	return W.WName()
}
func (W _gorm_io_gorm_Index) Option() string {
	return W.WOption()
}
func (W _gorm_io_gorm_Index) PrimaryKey() (isPrimaryKey bool, ok bool) {
	return W.WPrimaryKey()
}
func (W _gorm_io_gorm_Index) Table() string {
	return W.WTable()
}
func (W _gorm_io_gorm_Index) Unique() (unique bool, ok bool) {
	return W.WUnique()
}
...
func (W _gorm_io_gorm_Migrator) AutoMigrate(dst ...interface{}) error {
	return W.WAutoMigrate(dst...)
}
...
func (W _gorm_io_gorm_Migrator) CreateTable(dst ...interface{}) error {
	return W.WCreateTable(dst...)
}
func (W _gorm_io_gorm_Migrator) CreateView(name string, option gorm.ViewOption) error {
	return W.WCreateView(name, option)
}
func (W _gorm_io_gorm_Migrator) CurrentDatabase() string {
	return W.WCurrentDatabase()
}
...
func (W _gorm_io_gorm_Migrator) DropTable(dst ...interface{}) error {
	return W.WDropTable(dst...)
}
func (W _gorm_io_gorm_Migrator) DropView(name string) error {
	return W.WDropView(name)
}
...
func (W _gorm_io_gorm_Migrator) GetTables() (tableList []string, err error) {
	return W.WGetTables()
}
...
func (W _gorm_io_gorm_Migrator) HasTable(dst interface{}) bool {
	return W.WHasTable(dst)
}
...
func (W _gorm_io_gorm_Option) AfterInitialize(a0 *gorm.DB) error {
	return W.WAfterInitialize(a0)
}
func (W _gorm_io_gorm_Option) Apply(a0 *gorm.Config) error {
	return W.WApply(a0)
}
...
func (W _gorm_io_gorm_Plugin) Initialize(a0 *gorm.DB) error {
	return W.WInitialize(a0)
}
func (W _gorm_io_gorm_Plugin) Name() string {
	return W.WName()
}
...
func (W _gorm_io_gorm_Rows) Close() error {
	return W.WClose()
}
func (W _gorm_io_gorm_Rows) ColumnTypes() ([]*sql.ColumnType, error) {
	return W.WColumnTypes()
}
func (W _gorm_io_gorm_Rows) Columns() ([]string, error) {
	return W.WColumns()
}
func (W _gorm_io_gorm_Rows) Err() error {
	return W.WErr()
}
func (W _gorm_io_gorm_Rows) Next() bool {
	return W.WNext()
}
func (W _gorm_io_gorm_Rows) Scan(dest ...interface{}) error {
	return W.WScan(dest...)
}
...
func (W _gorm_io_gorm_StatementModifier) ModifyStatement(a0 *gorm.Statement) {
	W.WModifyStatement(a0)
}
...
func (W _gorm_io_gorm_TableType) Comment() (comment string, ok bool) {
	return W.WComment()
}
func (W _gorm_io_gorm_TableType) Name() string {
	return W.WName()
}
func (W _gorm_io_gorm_TableType) Schema() string {
	return W.WSchema()
}
func (W _gorm_io_gorm_TableType) Type() string {
	return W.WType()
}
...
func (W _gorm_io_gorm_Tx) Commit() error {
	return W.WCommit()
}
...
func (W _gorm_io_gorm_Tx) Rollback() error {
	return W.WRollback()
}
...
func (W _gorm_io_gorm_TxCommitter) Commit() error {
	return W.WCommit()
}
func (W _gorm_io_gorm_TxCommitter) Rollback() error {
	return W.WRollback()
}
