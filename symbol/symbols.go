...
//go:generate yaegi extract github.com/goravel/framework/contracts/database/orm
//go:generate yaegi extract github.com/goravel/framework/database/db
//go:generate yaegi extract github.com/goravel/framework/support/path
